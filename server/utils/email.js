...
const forgotPassEmail = (email, passToken) => {
  ...
  <div>Please <a href="https://staff.tomandcaptain.com/reset/${passToken}">click here</a> to reset your password. (or copy/paste this address into your browser: https://staff.tomandcaptain.com/reset/${passToken})</div>
